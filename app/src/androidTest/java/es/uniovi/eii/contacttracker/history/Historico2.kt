...
isDisplayed()))
        textView.check(matches(withText("No hay localizaciones que mostrar")))
...
isDisplayed()))
        textView2.check(matches(withText("34")))
        
        val textView3 = onView(
allOf(withText("localizaciones"),
withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
isDisplayed()))
        textView3.check(matches(withText("localizaciones")))
...
isDisplayed()))
        ...
        // Comprobar contenido del primer Item del RecyclerView
        onView(withId(R.id.recyclerViewUserLocations))
            .check(matches(atPosition(0, hasDescendant(withText("Latitud")))))
        onView(withId(R.id.recyclerViewUserLocations))
            .check(matches(atPosition(0, hasDescendant(withText("43.531759")))))
        onView(withId(R.id.recyclerViewUserLocations))
            .check(matches(atPosition(0, hasDescendant(withText("Longitud")))))
        onView(withId(R.id.recyclerViewUserLocations))
            .check(matches(atPosition(0, hasDescendant(withText("-5.911805")))))
...
withParent(withParent(withId(R.id.txtInputLayoutHistoryDate))),
isDisplayed()))
        editText2.check(matches(withText("05/${MONTH}/2021")))
        
        val textView8 = onView(
allOf(withId(R.id.labelHistoryNoLocations), withText("No hay localizaciones que mostrar"),
withParent(withParent(withId(R.id.nav_host_fragment))),
isDisplayed()))
        textView8.check(matches(withText("No hay localizaciones que mostrar")))
        }
