...
data class RiskContactLocation(
        ...
        val userContactPointName: String, /* Nombre de la localización del usuario */
        @Embedded(prefix = "user_") val userContactPoint: Point, /* Localización de Usuario */
        val positiveContactPointName: String, /* Nombre de la localización del positivo */
        @Embedded(prefix = "positive_") val positiveContactPoint: Point, /* Localización del Positivo */
